...
app.get('/api/tasks', authenticateToken, async (req, res) => {
  try {
    ...
    let query = `SELECT id, userid, date, deadline, title, priority, comment, done, donedate, focussessions, isrecurring as isRecurring, recurrencetype as recurrenceType, recurrencevalue as recurrenceValue, isgenerated as isGenerated, time FROM tasks WHERE userid = ?`;
